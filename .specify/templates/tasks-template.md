...
**Tests**: Test tasks are REQUIRED. Include unit, integration, and contract/end-to-end
coverage as applicable to the feature scope.
...
- [ ] T004 [P] Configure static analysis and CI quality gates
...
- [ ] T011 Define UX consistency checklist for shared components/states
- [ ] T012 Define performance budget checks and benchmark approach
...
- [ ] T013 [P] [US1] Unit tests for core logic in tests/unit/test_[name].py
...
- [ ] T022 [US1] Validate UX consistency states for this story
- [ ] T023 [US1] Validate performance budget for this story
...
- [ ] T024 [P] [US2] Unit tests for core logic in tests/unit/test_[name].py
...
- [ ] T031 [US2] Validate UX consistency states for this story
- [ ] T032 [US2] Validate performance budget for this story
...
- [ ] T033 [P] [US3] Unit tests for core logic in tests/unit/test_[name].py
...
- [ ] T039 [US3] Validate UX consistency states for this story
- [ ] T040 [US3] Validate performance budget for this story
...
- [ ] TXXX [P] Additional unit tests in tests/unit/ as needed
- [ ] TXXX Security hardening
- [ ] TXXX Validate all constitution gates are passing in CI
...
Task: "Unit tests for core logic in tests/unit/test_[name].py"
...
- Include explicit UX consistency and performance validation tasks per story
